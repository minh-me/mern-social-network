...
const transErrors = {
  ...
  account_removed:
    'This account has been removed from the system, if you believe this is a misunderstanding, please contact our support.',
  account_not_active:
    'Registered email but not active account, please check your email or contact our support.',
  ...
  server_error:
    'There is an error on the server side, please contact our department to report this error. Thank you!',
}
