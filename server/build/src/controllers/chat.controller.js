...
exports.updateChat = exports.getChats = exports.getChat = exports.deleteChat = exports.createChat = void 0;
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _services.chatService.createChat(_objectSpread(_objectSpread({}, req.body), {}, {
              users: [].concat((0, _toConsumableArray2["default"])(req.body.users), [req.user.id])
            }));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            options = (0, _pick["default"])(req.query, ['sort', 'select', 'sortBy', 'limit', 'page']);
            _context2.next = 4;
