...
exports.updateComment = exports.getComments = exports.getComment = exports.deleteComment = exports.createComment = void 0;
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _services.commentService.createComment(_objectSpread(_objectSpread({}, req.body), {}, {
              user: req.user.id
            }));
